...
public class FrmCadastroFuncionario extends javax.swing.JFrame {
    ...
    //Constantes
    static String tituloForm = "Cadastro de Funcionários";
    static String[] tableColumnsName = {"Id", "Login", "Nome", "Telefone", "Acessa Sistema?","Nível de Acesso"};
    static String queryPadrao = "SELECT ID, LOGIN, NOME, TELEFONE,"
                    + " CASE ACESSASISTEMA WHEN 1 THEN 'Sim' WHEN 0 THEN 'Não' END," 
                    + " NVLACESSO"
                    + " FROM FUNCIONARIO;";
    /**
    ...
    public FrmCadastroFuncionario() {
        ...
        try {            
            ...
            //definindo um listener para o checkbox de senha
            chkAcessaSistema.addItemListener((ItemEvent e) -> {
                if(chkAcessaSistema.isSelected()){
    ...
    private void initComponents() {
        ...
        try{
            ...
            telefone.setPlaceholderCharacter(' ');
            ftxtTelefone = new javax.swing.JFormattedTextField(telefone);
            lblCampoTxt2 = new javax.swing.JLabel();
            txtNome = new javax.swing.JTextField();
            chkAcessaSistema = new javax.swing.JCheckBox();
            ...
            lblTituloForm.setText("Funcionários do Sistema");
            ...
            btnUltimo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/double_left-48.png"))); // NOI18N
            ...
            lblCampoTxt1.setText("Login: ");

            txtLogin.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

            lblCampoFtxt1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
            lblCampoFtxt1.setText("Telefone:");

        } catch (Exception e){
        }
        ftxtTelefone.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

        lblCampoTxt2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblCampoTxt2.setText("Nome:");

        txtNome.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

        chkAcessaSistema.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        chkAcessaSistema.setText("Possui acesso ao sistema");

        pnlSenha.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Senha"));

        lblCampoTxt3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblCampoTxt3.setText("Nível de acesso");

        lblCampoTxt4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblCampoTxt4.setText("Senha:");
        ...
        pnlSenhaLayout.setHorizontalGroup(
            ...
            .addGroup(pnlSenhaLayout.createSequentialGroup()
                ...
                .addGroup(pnlSenhaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblCampoTxt4, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(pnlSenhaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cbxNivelAcesso, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ptxtSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        pnlDetalheLayout.setHorizontalGroup(
            ...
            .addGroup(pnlDetalheLayout.createSequentialGroup()
                ...
                .addGroup(pnlDetalheLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlDetalheLayout.createSequentialGroup()
                        .addGroup(pnlDetalheLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(chkAcessaSistema)
                            .addGroup(pnlDetalheLayout.createSequentialGroup()
                                .addComponent(lblCampoTxt1, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(pnlDetalheLayout.createSequentialGroup()
                                .addGroup(pnlDetalheLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lblCampoFtxt1, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lblCampoTxt2, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(pnlDetalheLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(ftxtTelefone, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        try {
            String query = "";
            String message = "";
            String pwdDescriptado = new String(ptxtSenha.getPassword()).trim();
            String nvlAcesso;
            ...
            switch (statusForm) {
                ...
                */
                case INCLUSAO:
                    ...
                    if (cbxNivelAcesso.getSelectedIndex() == -1){
                        nvlAcesso = "";
                    } else {
                        nvlAcesso = String.valueOf(cbxNivelAcesso.getSelectedItem());
                    }
                    fnLocal = new Funcionario(txtLogin.getText(), 
                            txtNome.getText(),
                            ftxtTelefone.getText(1, 2) + ftxtTelefone.getText(4,9), 
                            nvlAcesso,
                            pwdDescriptado, 
                            chkAcessaSistema.isSelected());

                    fnLocal.InsertFuncionario();
                    fnLocal.AtualizaId();

                    message = "Funcionário " + txtNome.getText() + " incluído com sucesso!";
                ...
                */
                case PESQUISA:
                    if (!toolbox.ValidaTextField(txtNome, false)){
                        throw new Exception("Campo 'Nome' preenchido incorretamente!");
                    }
                    query = "SELECT ID, LOGIN, NOME, TELEFONE,"
                    + " CASE ACESSASISTEMA WHEN 1 THEN 'Sim' WHEN 0 THEN 'Não' END," 
                    + " NVLACESSO"
                    + " FROM FUNCIONARIO "
                ...
                */
                case ALTERACAO:
                    ValidaCamposFuncionario();
                    message = "Tem certeza que deseja alterar o funcionário " + txtNome.getText() + " ?";
                    if (JOptionPane.showConfirmDialog(this, message, "Alterar funcionário",
                            JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                        
                        if (cbxNivelAcesso.getSelectedIndex() == -1 || !chkAcessaSistema.isSelected()){
                            nvlAcesso = "";
                        } else {
                            nvlAcesso = String.valueOf(cbxNivelAcesso.getSelectedItem());
                        }
                        fnLocal = new Funcionario(idFuncionarioAtual,
                                txtLogin.getText(), 
                                txtNome.getText(),
                                ftxtTelefone.getText(1, 2) + ftxtTelefone.getText(4,9), 
                                nvlAcesso,
                        ...
                        fnLocal.UpdateFuncionario();
                        message = "Funcionário " + txtNome.getText() + " alterado com sucesso!";
                        JOptionPane.showMessageDialog(this, message, "Alterar funcionário", JOptionPane.INFORMATION_MESSAGE);
                    }
                    query = queryPadrao;
    ...
    private void AlteraModoOperacaoForm(ModoOperacaoForm estado) {
        ...
        Component[] compPnlSenha = pnlSenha.getComponents();
        switch(estado){
        case PADRAO:
            ...
            for (Component comp2 : compPnlSenha) {
        ...
        case EXCLUSAO:
            try {
                ...
                if (tblMestre.getSelectedRow() != -1){
                    aviso = "Tem certeza que deseja excluir o funcionário " + txtNome.getText() + " ?";
                    if (JOptionPane.showConfirmDialog(this, aviso, "Excluir funcionário",
                            JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                        fnLocal = new Funcionario(idFuncionarioAtual);
                        fnLocal.DeleteFuncionario();
                        aviso = "Funcionário excluído com sucesso!";
                        JOptionPane.showMessageDialog(this, aviso, "Excluir funcionário", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
                else {
                    aviso = "Nenhum funcionário selecionado!\n\nClique em um dos funcionários, para poder efetuar a exclusão!";
        ...
        case ALTERACAO:
            ...
            fnLocal = new Funcionario(idFuncionarioAtual);
            try {
                ptxtSenha.setText(fnLocal.RecuperaSenha());
            } catch (Exception ex) {
    ...
    private void ValidaCamposFuncionario() throws Exception{
        if (!toolbox.ValidaTextField(txtLogin, false)){
            throw new Exception("Campo 'Login' preenchido incorretamente!");
        }                   
        if (!toolbox.ValidaTextField(txtNome, false)){
            throw new Exception("Campo 'Nome' preenchido incorretamente!");
        }                   
        if (!toolbox.ValidaFTextField(ftxtTelefone, false)){
            throw new Exception("Campo 'Telefone' preenchido incorretamente!");
        }
        if (chkAcessaSistema.isSelected()){
            if (cbxNivelAcesso.getSelectedIndex() == -1) {
                throw new Exception("Campo 'Nível de Acesso' deve ter um valor selecionado\n" +
                    "se a opção 'Acessa Sistema' estiver selecionada!");
            }
            if (!toolbox.ValidaPasswordField(ptxtSenha, false)){
    ...
    private void CarregaValoresPadrao() {
        try {
            cbxNivelAcesso.setModel(sql.GetComboBoxData("SELECT NVLACESSO FROM FUNCIONARIO_ACESSO;", cbxNivelAcesso));
    ...
    private class ListSelectionListenerImpl implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent e) {
            try {
                idFuncionarioAtual = (int) tblMestre.getValueAt(tblMestre.getSelectedRow(), 0);
                lblRegistroAtual.setText(String.valueOf(tblMestre.getSelectedRow() + 1));
                ...
                if (tblMestre.getValueAt(tblMestre.getSelectedRow(), 3) == null){
                    ...
                    ftxtTelefone.setText(String.valueOf(tblMestre.getValueAt(tblMestre.getSelectedRow(), 3)));
                }
                ...
                cbxNivelAcesso.setSelectedItem(tblMestre.getValueAt(tblMestre.getSelectedRow(), 5));  
            } catch (Exception ex) {
    ...
    private javax.swing.JCheckBox chkAcessaSistema;
    ...
    private javax.swing.JLabel lblCampoTxt2;
